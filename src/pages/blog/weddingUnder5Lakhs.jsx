...
// Verified Indian bridal / wedding detail photo (Unsplash)
...
const STEPS = [
  { n: 1, title: 'Lock the budget with both families', body: "Agree on a hard ceiling before any planning starts. Write it down. Decide who contributes what. Clarity here prevents every argument later." },
  { n: 2, title: 'Decide guest count first — everything follows', body: 'At ₹5 lakhs, keep it under 120 guests — ideally 80–100 for breathing room. Every extra 50 guests adds ~₹50K–70K to the bill.' },
  { n: 3, title: 'Choose the right venue', body: 'Hotels are off the table. Community halls (₹15K–40K), temple halls (often free), home terraces, or farmhouses on the outskirts give you great ambience for a fraction of the cost.' },
  { n: 4, title: 'Plan the menu smartly', body: 'A local halwai at ₹350–500/plate beats any catering company. Skip live counters. For morning functions, chai + breakfast is much gentler on the wallet than a full lunch.' },
  { n: 5, title: 'Keep it to 1–2 functions', body: "Haldi at home + main ceremony, or Mehendi at home + reception. Combining functions saves venue hire, decor, and catering for an entire day." },
  { n: 6, title: 'Book a photographer — but the right one', body: "Don't skip photos entirely. A talented second-year photography student or emerging local shooter gives stunning results at ₹35K–55K. Review 3 portfolios minimum." },
  { n: 7, title: 'Track every paisa in real time', body: "Use Wedora's free budget planner to enter quotes, log advance payments, and watch your running total — so nothing surprises you on wedding day." },
];
...
const FAQS = [
  { q: 'Can you really have a good Indian wedding for under ₹5 lakhs?', a: 'Absolutely yes. Thousands of Indian couples do it every year. The key is keeping guests under 120, choosing a non-hotel venue, using a local caterer, and doing some of the work yourself. A ₹5 lakh wedding planned with intention will outshine a flashier one done without thought.' },
  { q: 'What is the biggest expense in a ₹5 lakh Indian wedding?', a: 'Catering and venue together typically take 40–50% of budget — roughly ₹2–2.5 lakhs. This is why your guest count and venue choice are the two most important decisions. Photography, bridal outfit, and decor follow.' },
  { q: 'How many guests can I invite with a ₹5 lakh budget?', a: 'Realistically, 80–120 guests in most Indian cities. In Tier 2/3 cities you can stretch to 150 with careful planning. In metros like Mumbai or Delhi, 60–80 guests gives you the best experience without compromise.' },
  { q: 'Should I skip a photographer to save money?', a: "We strongly recommend against it — photography is the one thing you keep forever. Instead, find an emerging local photographer or a talented photography student. You can get excellent coverage for ₹35K–55K if you look beyond the big studios." },
  { q: 'How do I handle family pressure to spend more?', a: "Be calm, clear, and early. Have the conversation before any planning starts. Involve family in decisions within the budget — menu, guest list — so they feel included. Remind them a debt-free start to married life is more valuable than one extravagant day." },
  { q: 'Which city in India is best for a budget wedding under ₹5 lakhs?', a: 'Tier 2 cities like Pune, Jaipur, Nagpur, Indore, Bhopal, and Coimbatore offer the best value. Community halls are affordable, local caterers are excellent, and photographers deliver quality at lower rates. Smaller cities in UP, Rajasthan, and Bihar can go even lower.' },
];
...
function FaqItem({ item, open, onToggle }) {
  return (
    <div className="rounded-2xl border border-gray-100 bg-white/90 overflow-hidden shadow-sm">
      <button type="button" onClick={onToggle} className="w-full flex items-center justify-between gap-4 text-left px-5 py-4 hover:bg-rose-gold/5 transition-colors" aria-expanded={open}>
      ...
      {open && (
        <div className="px-5 pb-4 text-gray-600 text-sm leading-relaxed border-t border-gray-50 pt-3">{item.a}</div>
      )}
    </div>
  );
}
...
export function WeddingUnder5LakhsArticle({ post, readTime, copied, onShare, affiliateHref, affiliateCtaLabel }) {
    ...
    <div className="min-h-screen bg-[#faf7f8]">
      ...
      <header className="relative pt-24 pb-16 md:pb-24 px-4 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/90 border border-emerald-400/30 shadow-sm mb-6 animate-fade-in-up">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-emerald-700">2026 Guide · Budget Wedding</span>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-gray-900 leading-[1.08] mb-6 animate-fade-in-up">
            Wedding Under{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-teal-500 to-rose-gold">₹5 Lakhs</span>{' '}
            in India
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Real numbers, honest hacks, and a step-by-step plan for a beautiful, debt-free Indian wedding — no matter how tight the budget.
          </p>
        ...
        {post.featured_image && (
          <div className="max-w-5xl mx-auto mt-12 rounded-3xl overflow-hidden shadow-2xl shadow-emerald-400/15 border-4 border-white ring-1 ring-emerald-100">
            <img src={ensureHttps(post.featured_image)} alt="Indian bride — intimate wedding celebration" className="w-full aspect-[21/9] object-cover" loading="eager" />
          </div>
        )}
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 lg:px-8 pb-24 space-y-16 md:space-y-24">
        ...
        <section className="relative">
          ...
          <div className="relative rounded-[1.75rem] bg-gradient-to-br from-white via-white to-emerald-50/60 border border-emerald-100/80 p-8 md:p-10 shadow-xl">
            ...
            <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              The moment you announce your engagement, someone in the family will whisper a venue name that costs more than your entire budget. Suddenly you're not just planning a wedding — you're managing expectations, <em>izzat</em>, and a wishlist that grows daily.
            </p>
            <p className="text-gray-700 leading-relaxed text-lg">
              Here's what nobody tells you: some of the most heartfelt, memorable weddings in India have happened in community halls with marigold garlands and home-cooked food. This guide gives you every tool to plan yours — with real numbers, zero fluff, and zero debt.
            </p>
          </div>
        </section>
        ...
        <section id="realistic">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="text-3xl font-serif font-bold text-gray-900">Is ₹5 lakhs realistic in 2026?</h2>
              <p className="text-gray-500 text-sm mt-1">Short answer: yes — if you plan smart.</p>
            </div>
          </div>
          <p className="text-gray-600 mb-6 text-lg leading-relaxed">A ₹5 lakh wedding works beautifully when:</p>
          <div className="grid sm:grid-cols-2 gap-3 mb-8">
            {['Guest list between 50–120 people', 'Non-hotel venue (community hall, home, farmhouse)', 'Maximum 1–2 functions (not a 3-day extravaganza)', 'Willingness to DIY and involve family', 'Vendors booked 6+ months in advance', 'Off-season or weekday date chosen'].map((point) => (
              <div key={point} className="flex items-start gap-3 p-4 rounded-xl bg-white border border-gray-100 shadow-sm">
          ...
          <div className="flex gap-3 p-5 rounded-2xl bg-amber-50 border border-amber-200/60">
            ...
            <p className="text-amber-900 text-sm leading-relaxed">
              <strong>Real talk:</strong> In Tier 2/3 cities a ₹5 lakh wedding for 150 guests is absolutely achievable. In metros, aim for 60–80 guests for the best experience at this budget.
            </p>
          </div>
        </section>
        ...
        <section id="breakdown">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="text-3xl font-serif font-bold text-gray-900">Complete ₹5 lakh budget breakdown</h2>
              <p className="text-gray-500 text-sm mt-1">Recommended allocation across all categories.</p>
            </div>
          </div>
              ...
              <table className="w-full text-sm md:text-base">
                <thead>
                  <tr className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-left">
                    ...
                    <th className="px-4 py-4 font-semibold hidden md:table-cell">How to stay in range</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {BUDGET_TABLE.map((row) => (
                    <tr key={row.cat} className="hover:bg-emerald-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-gray-500 text-sm hidden md:table-cell">{row.tip}</td>
                    </tr>
                  ))}
                  <tr className="bg-emerald-600 text-white">
                    ...
                    <td className="px-4 py-4 text-white/80 text-sm hidden md:table-cell">Stay on the lower end of each range</td>
                  </tr>
                </tbody>
              </table>
            </div>
          </div>
          <p className="mt-4 text-gray-500 text-sm text-center italic">Figures are averages for Tier 2 cities. Metro cities may run 20–30% higher — adjust accordingly.</p>
        </section>

        {/* Steps */}
        <section id="steps">
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-10 text-center">Step-by-step: how to pull it off</h2>
            ...
            <div className="space-y-8">
              {STEPS.map((s) => (
                <div key={s.n} className="relative flex gap-4 md:gap-8 sm:pl-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white font-bold flex items-center justify-center shrink-0 shadow-lg z-10 text-sm md:text-base">{s.n}</div>
        ...
        <section id="tips">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-3">20 genius ways to save</h2>
            <p className="text-gray-600 max-w-xl mx-auto">Real tactics Indian couples used to stay under ₹5 lakhs — without it looking "budget".</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {TIPS.map((tip, i) => (
              <div key={tip} className="group p-4 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md hover:border-emerald-400/30 transition-all">
                <span className="inline-flex w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 text-xs font-bold items-center justify-center mb-3 group-hover:bg-emerald-500 group-hover:text-white transition-colors">{i + 1}</span>
        ...
        <section id="example">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="text-3xl font-serif font-bold text-gray-900">Real example: ₹4.84 lakh wedding, Pune</h2>
          ...
          <div className="flex gap-3 p-5 rounded-2xl bg-emerald-50 border border-emerald-200/60">
            ...
            <p className="text-emerald-900 text-sm leading-relaxed">
              <strong>The result:</strong> A warm, beautiful wedding with 100 happy guests, stunning photos, and zero debt. The bride says it was the best decision they made — choosing intimacy over extravagance.
            </p>
          </div>
        </section>
        ...
        {/* Vendors */}
        <section id="vendors">
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-8">Choosing vendors on a tight budget</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Camera, title: 'Photography', body: "Don't skip it — you'll look at these forever. An emerging local photographer or final-year student gives stunning results from ₹35K. Review 3 portfolios.", color: 'from-sky-500 to-blue-600' },
              { icon: Utensils, title: 'Catering', body: 'Food is what guests remember. A local halwai at ₹350–500/plate is far better than corporate caterers at ₹800+. Always do a tasting before confirming.', color: 'from-emerald-500 to-teal-600' },
              { icon: Flower2, title: 'Decor', body: 'Biggest savings are here. Marigold + jasmine decor is traditional, stunning, and costs 1/3rd of roses. DIY fairy lights transform any hall.', color: 'from-pink-500 to-rose-600' },
            ].map((v) => (
          ...
          <p className="mt-6 text-gray-600 text-center text-sm">Bridal wear: fashion exhibitions, end-of-season sales, and rental lehengas deliver the same wow at 30–40% of boutique prices.</p>
        </section>

        {/* Checklist */}
        <section id="checklist">
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-2 text-center">Your ₹5 lakh wedding checklist</h2>
          <p className="text-center text-gray-500 mb-8 text-sm">Tick as you go — or let Wedora track it with automated reminders.</p>
          <div className="rounded-2xl border border-gray-100 overflow-hidden shadow-lg bg-white">
            <div className="overflow-x-auto">
        ...
        <section className="rounded-[2rem] bg-gradient-to-br from-emerald-400 via-teal-500 to-rose-gold p-1 shadow-2xl shadow-emerald-400/30">
          <div className="rounded-[1.85rem] bg-gray-900 px-8 py-12 md:px-12 text-center">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-white mb-4">Tools that make budget planning easy</h2>
            <p className="text-gray-300 max-w-xl mx-auto mb-8 leading-relaxed">Track vendor quotes, advances, and balances in one place. Manage guests, deadlines, and payments — without spreadsheet chaos. It's free.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/signup" className="inline-flex items-center justify-center px-8 py-3.5 rounded-xl bg-white text-gray-900 font-semibold hover:bg-emerald-50 transition-colors shadow-lg">Start free with Wedora</Link>
              <Link to="/" className="inline-flex items-center justify-center px-8 py-3.5 rounded-xl border-2 border-white/30 text-white font-semibold hover:bg-white/10 transition-colors">Explore features</Link>
            </div>
          </div>
        </section>
        ...
        <section className="text-center max-w-2xl mx-auto pb-8">
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-gray-900 mb-4">Your ₹5 lakh wedding can be the most memorable one</h2>
          <p className="text-gray-600 leading-relaxed mb-8">The couples who remember their wedding most fondly are not the ones who spent the most. They're the ones who were most present, most intentional, and surrounded by people who genuinely love them. Set your budget, lock the guest list, and let Wedora keep everything on track from today.</p>
      ...
      <div className="border-t border-rose-100 bg-white/90 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link to="/signup" className="inline-flex items-center justify-center px-8 py-3 rounded-xl bg-gradient-to-r from-rose-gold to-plum text-white text-sm font-semibold shadow-lg hover:shadow-xl transition-all">Plan your wedding free — Wedora</Link>
        </div>
      </div>
    </div>
  );
