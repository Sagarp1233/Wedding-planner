...
import { COURT_MARRIAGE_SLUG, getStaticCourtMarriagePost } from './blog/courtMarriageGuide';
...
const CourtMarriageGuideArticle = lazy(() =>
  import('./blog/courtMarriageGuide').then(m => ({ default: m.CourtMarriageGuideArticle }))
);
const WeddingMuhuratDatesArticle = lazy(() =>
  import('./blog/weddingMuhuratDates2026').then(m => ({ default: m.WeddingMuhuratDatesArticle }))
);
const IndianWeddingCateringGuideArticle = lazy(() =>
  import('./blog/indianWeddingCateringGuide').then(m => ({ default: m.IndianWeddingCateringGuideArticle }))
);
...
export default function BlogPostPage() {
  ...
  if (slug === COURT_MARRIAGE_SLUG) {
    return (
      <>
        {postHelmet}
        <Suspense fallback={<ArticleSkeleton />}>
          <CourtMarriageGuideArticle post={post} readTime={17} copied={copied} onShare={handleShareURL} affiliateHref={affiliateHref} affiliateCtaLabel={affiliateCtaLabel} />
        </Suspense>
      </>
    );
  }
  if (slug === MUHURAT_DATES_SLUG) {
    return (
      <>
        {postHelmet}
        <Suspense fallback={<ArticleSkeleton />}>
          <WeddingMuhuratDatesArticle post={post} readTime={13} copied={copied} onShare={handleShareURL} affiliateHref={affiliateHref} affiliateCtaLabel={affiliateCtaLabel} />
        </Suspense>
      </>
    );
  }
  if (slug === CATERING_GUIDE_SLUG) {
    return (
      <>
        {postHelmet}
        <Suspense fallback={<ArticleSkeleton />}>
          <IndianWeddingCateringGuideArticle post={post} readTime={14} copied={copied} onShare={handleShareURL} affiliateHref={affiliateHref} affiliateCtaLabel={affiliateCtaLabel} />
        </Suspense>
      </>
    );
  }
  ...
  if (slug === VENUE_GUIDE_SLUG) {
    return (
      <>
        {postHelmet}
        <Suspense fallback={<ArticleSkeleton />}>
          <WeddingVenueGuideArticle post={post} readTime={14} copied={copied} onShare={handleShareURL} affiliateHref={affiliateHref} affiliateCtaLabel={affiliateCtaLabel} />
        </Suspense>
      </>
    );
  }
  if (slug === DECOR_GUIDE_SLUG) {
    return (
      <>
        {postHelmet}
        <Suspense fallback={<ArticleSkeleton />}>
          <IndianWeddingDecorGuideArticle post={post} readTime={12} copied={copied} onShare={handleShareURL} affiliateHref={affiliateHref} affiliateCtaLabel={affiliateCtaLabel} />
        </Suspense>
      </>
    );
  }
